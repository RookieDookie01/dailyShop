          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <form method="POST" action="womenformal.php">
                <?php
                  $products_query = "SELECT * FROM products WHERE product_type = 'Women Formal' ";
                    ...
                    {?>
                      <li>
                        <figure>
                          ...
                          <a href="womenformal.php?t=<?= $item['product_id']; ?>" class="aa-add-card-btn"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                          <figcaption>
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="tag-cloud">
                ...
                <a href="womenformal.php">Formal</a>
                <a href="womentrousers.php">Trousers</a>
              </div>
            </div>
            <!-- single sidebar -->
          </aside>
