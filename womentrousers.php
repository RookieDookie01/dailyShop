          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <form method="POST" action="womentrousers.php">
                <?php
                  $products_query = "SELECT * FROM products WHERE product_type = 'Women Trousers' ";
                    ...
                    {?>
                      <li>
                        <figure>
                          ...
                          <a href="womentrousers.php?t=<?= $item['product_id']; ?>" class="aa-add-card-btn"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                          <figcaption>
