          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <form method="POST" action="mentrousers.php">
                <?php
                  $products_query = "SELECT * FROM products WHERE product_type = 'Men Trousers' ";
                    ...
                    {?>
                      <li>
                        <figure>
                          ...
                          <a href="mentrousers.php?t=<?= $item['product_id']; ?>" class="aa-add-card-btn"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                          <figcaption>
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="tag-cloud">
                ...
                <a href="menshirt.php">Shirt</a>
                <a href="mentrousers.php">Trousers</a>
              </div>
            </div>
            <!-- single sidebar -->
          </aside>
