          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <form method="POST" action="kidshirt.php">
                <?php
                  $products_query = "SELECT * FROM products WHERE product_type = 'Kids T-shirt' ";
                    ...
                    {?>
                      <li>
                        <figure>
                          ...
                          <a href="kidshirt.php?t=<?= $item['product_id']; ?>" class="aa-add-card-btn"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                          <figcaption>
